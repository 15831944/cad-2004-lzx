...
public:
	...
	static void BatchDoDwg(const CString& strCommand);
	static void BatchDoDwg2(void* pData);
	...
	static void SetPlineWidth(ads_name ss, double dFrom, double dTo, BOOL bIncludeBlk=TRUE);
