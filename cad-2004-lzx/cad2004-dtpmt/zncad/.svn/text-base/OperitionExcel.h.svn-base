...
public:
	...
	BOOL ReadDatafromExcel(int iNum_sheet,int iRow ,int iCol,double &dData);
	BOOL ReadDatafromExcel(int iNum_sheet,int iRow,int iCol,int &iData);
	...
	BOOL IsCellDouble( int iNum_sheet,int iRow,int iCol);
	BOOL IsCellCString( int iNum_sheet,int iRow,int iCol);
	BOOL IsCellInt( int iNum_sheet,int iRow,int iCol);
