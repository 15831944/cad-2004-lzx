...
BEGIN_MESSAGE_MAP(CCableInfoDlg, CAcUiDialog)
	...
	ON_EN_CHANGE(IDC_EDIT_CABLEINFO_BACKUP, OnEnChangeEditCableinfoBackup)
...
void CCableInfoDlg::OnEnChangeEditCableinfoBackup()
{
	// TODO:  如果该控件是 RICHEDIT 控件，则它将不会
	// 发送该通知，除非重写 CAcUiDialog::OnInitDialog()
...
// void CCableInfoDlg::OnBnClickedOk()
// {
// 	// TODO: 在此添加控件通知处理程序代码
// }
