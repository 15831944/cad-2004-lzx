...
// 	else if (strClassName== _T("class CDcDATA"))
	...
	else if (strClassName == _T("CDtDcDATA"))
	{
		nCols = 1 ;
		nRows = 19 ;
		CDtDcDATA *pDATA = dynamic_cast<CDtDcDATA*>(m_pEntDATA) ;
			...
			case 5:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bDC_HasBox?_T("是"):_T("否")) ;
				}
				break;
			case 6:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bDC_ShareBox?_T("是"):_T("否")) ;
				}
				break;
			case 7:
				{
					...
					cell.SetCellType(UGCT_DROPLIST) ;
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("FXX\nKAD\n")) ;	
					cell.SetText(pDATA->m_strDC_BoxType) ;
				}
				break;
			case 8:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("上\n下\n")) ;	
					cell.SetText(pDATA->m_strDC_BoxPos) ;
				}
				break;
			case 9:
				{
					cell.ClearAll() ;		
					cell.SetText(pDATA->m_strCableString) ;
					cell.SetParam(CELLTYPE_IS_EDITABLE);
	...
	else if (strClassName == _T("CCableImportDATA"))
	{
		nCols = 1 ;
		nRows = 5 ;
		CCableImportDATA *pDATA = dynamic_cast<CCableImportDATA*>(m_pEntDATA) ;
		SetNumberRows( nRows );
		SetNumberCols( nCols );
		for (int i=0; i<nRows; i++)
		{	
			GetCellIndirect( -1, i, &cell );
			cell.SetAlignment( UG_ALIGNLEFT|UG_ALIGNVCENTER );
			cell.SetText(pDATA->strCableImportItem[i]) ;
			SetCell(-1, i, &cell) ;			
			...
			case 0:
				{
					cell.ClearAll();
					cell.SetText(pDATA->m_strStation) ;//道岔名称取自块属性
					cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			case 1:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bIsJZ?_T("是"):_T("否")) ;	
				}
				break;
			case 2:
				{
					cell.ClearAll();
					cell.SetNumber(pDATA->d_nLoc);
					cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			case 3:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("上\n下\n")) ;					
					cell.SetText(pDATA->m_IsUP?_T("上"):_T("下")) ;
				}
				break;
			case 4:
				{
					cell.ClearAll();
					cell.SetNumber(pDATA->m_dDistToDeviceRoom);
					cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			}
	...
	else if (strClassName == _T("CXhDevice"))
	{
		nCols = 1 ;
		nRows = 14 ;
		CXhDevice *pDATA = dynamic_cast<CXhDevice*>(m_pEntDATA) ;
		SetNumberRows( nRows );
		SetNumberCols( nCols );
		for (int i=0; i<nRows; i++)
		{	
			GetCellIndirect( -1, i, &cell );
			cell.SetAlignment( UG_ALIGNLEFT|UG_ALIGNVCENTER );
			cell.SetText(pDATA->strXhDeviceItem[i]) ;
			SetCell(-1, i, &cell) ;			
			GetCellIndirect( 0, i, &cell);			
			cell.ClearAll() ;
			cell.SetAlignment( UG_ALIGNLEFT|UG_ALIGNVCENTER );
			...
			case 1:
				{
					//cell.ClearAll() ;		
					cell.SetText(pDATA->m_strBlkName) ;
					//cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			case 2:
			...
			case 3:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bHasBox?_T("是"):_T("否")) ;	
				}
				break;
			case 4:
				{
			...
			case 7:
				{
					cell.ClearAll();
					//进入箱盒芯数1
					cell.SetNumber(pDATA->m_nCoreNum1);
					cell.SetParam(CELLTYPE_IS_EDITABLE);
			...
			case 8:
				{
					cell.ClearAll();
					//进入箱盒芯数2
					cell.SetNumber(pDATA->m_nCoreNum2);
					cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			case 9:
				{
					cell.ClearAll() ;		
					cell.SetText(pDATA->m_strCable1) ;
					cell.SetParam(CELLTYPE_IS_EDITABLE);
				}
				break;
			case 10:
				{
					cell.ClearAll() ;		
					cell.SetText(pDATA->m_strCable2) ;
					cell.SetParam(CELLTYPE_IS_EDITABLE);
			...
			case 12:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bHasGT?_T("是"):_T("否")) ;	
				}
				break;
			case 13:
				{
					...
					cell.SetCellTypeEx(UGCT_DROPLISTHIDEBUTTON) ;		
					cell.SetLabelText(_T("否\n是\n")) ;					
					cell.SetText(pDATA->m_bHasGround?_T("是"):_T("否")) ;	
